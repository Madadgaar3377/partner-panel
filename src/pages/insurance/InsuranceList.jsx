      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-600 mt-1">Manage insurance offerings</p>
          </div>
          <button
        ...
        <div className="glass-red rounded-xl shadow-lg p-8 text-center">
          ...
          <h3 className="text-xl font-semibold text-gray-800 mb-2">No Insurance Plans</h3>
          <p className="text-gray-600 mb-6">Create your first insurance plan</p>
          <button
            onClick={() => navigate('/insurance/create')}
