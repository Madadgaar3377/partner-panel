...
const CreateLoan = () => {
  ...
  const nextStep = () => {
    if (currentStep === 1 && (!formData.productName || !formData.bankName)) {
      setError('Please fill in Product Name and Bank Name');
      return;
    }
    if (currentStep === 2 && !formData.majorCategory) {
        ...
        return (
          <div className="space-y-6 animate-in slide-in-from-right duration-500">
            <div className="flex items-center gap-3 mb-6 pb-4 border-b-2 border-blue-100">
              ...
              <h2 className="text-2xl font-bold text-gray-900">Step 1: Plan Identification</h2>
            </div>
        ...
        return (
          <div className="space-y-6 animate-in slide-in-from-right duration-500">
            <div className="flex items-center gap-3 mb-6 pb-4 border-b-2 border-purple-100">
              ...
              <h2 className="text-2xl font-bold text-gray-900">Step 2: Product Category</h2>
            </div>
        ...
        return (
          <div className="space-y-6 animate-in slide-in-from-right duration-500">
            <div className="flex items-center gap-3 mb-6 pb-4 border-b-2 border-green-100">
              ...
              <h2 className="text-2xl font-bold text-gray-900">Step 3: Financing Amount & Tenure</h2>
            </div>
            ...
            <div className="mt-8 pt-8 border-t border-gray-200">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-xl font-bold text-gray-900">Financing Type & Interest Rate</h3>
              </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <label className="flex items-start gap-3 p-4 border-2 border-gray-200 rounded-xl cursor-pointer hover:border-orange-400 transition-all">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">Standard bank loan with interest</p>
                      </div>
                    </label>
                    <label className="flex items-start gap-3 p-4 border-2 border-gray-200 rounded-xl cursor-pointer hover:border-orange-400 transition-all">
                      <input
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">Shariah-compliant, no interest (Riba)</p>
                      </div>
                    </label>
                  </div>
                </div>
        ...
        return (
          <div className="space-y-6 animate-in slide-in-from-right duration-500">
            <div className="flex items-center gap-3 mb-6 pb-4 border-b-2 border-red-100">
              ...
              <h2 className="text-2xl font-bold text-gray-900">Step 4: Eligibility & Target Audience</h2>
            </div>
        ...
        return (
          <div className="space-y-6 animate-in slide-in-from-right duration-500">
            <div className="flex items-center gap-3 mb-6 pb-4 border-b-2 border-teal-100">
              ...
              <h2 className="text-2xl font-bold text-gray-900">Step 5: Description & Documents</h2>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-3xl p-6 shadow-lg border border-blue-100 mb-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 mb-1">Add New Loan Plan</h1>
              <p className="text-gray-600">Create a new financing plan for your customers</p>
            </div>
            <button
